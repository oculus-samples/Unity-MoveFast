...
namespace Oculus.Interaction.MoveFast
{
    ...
    public class UIList : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public ILifeCycleHandler LifeCycleHandler { get => _lifeCycleHandler; set => _lifeCycleHandler = value; }
        ...
        void ISerializationCallbackReceiver.OnAfterDeserialize() => _lifeCycleHandler = _defaultLifecycleHandler;
