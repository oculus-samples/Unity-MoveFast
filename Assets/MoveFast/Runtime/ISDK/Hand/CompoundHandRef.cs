...
namespace Oculus.Interaction.ComprehensiveSample
{
    ...
    public class CompoundHandRef : MonoBehaviour, IHand, HandDataSource
    {
        ...
        public List<IHand> Hands { get; private set; }

        private IHand _bestHand = NullHand.instance;
        [SerializeField]
        List<Component> _aspects;
        ...
        {
            return _bestHand.GetCenterEyePose(out pose);
        }

        public bool TryGetAspect<TComponent>(out TComponent foundComponent) where TComponent : class
        {
            return _bestHand.TryGetAspect(out foundComponent);
        }
    }
