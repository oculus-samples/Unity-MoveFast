...
Shader "Interaction/OculusHand"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			Tags
			{
				"RenderType" = "Transparent" "Queue" = "Transparent" "IgnoreProjector" = "True" "LightMode" = "SRPDefaultUnlit"
			}
			ZWrite On
			ColorMask 0
		}
		...
		{	
			...
			Tags
			{
				"RenderType" = "Transparent" "Queue" = "Transparent" "IgnoreProjector" = "True" "LightMode" = "LightweightForward"
			}
			Cull Front
		...
		Pass
		{
			...
			Tags
			{
				"RenderType" = "Transparent" "Queue" = "Transparent" "IgnoreProjector" = "True" "IsEmissive" = "true" "LightMode" = "UniversalForward"
			}
