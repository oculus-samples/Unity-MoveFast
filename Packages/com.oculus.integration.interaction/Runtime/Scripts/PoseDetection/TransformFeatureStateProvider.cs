...
namespace Oculus.Interaction.PoseDetection
{
    ...
    internal class TransformFeatureStateCollection
    {
        ...
        internal bool IsRegistered(TransformConfig transformConfig)
        {
            return _idToTransformStateInfo.ContainsKey(transformConfig.InstanceId);
        }
    }
    ...
    public class TransformFeatureStateProvider : MonoBehaviour
    {
        ...
        public bool IsRegistered(TransformConfig transformConfig)
        {
            return _transformFeatureStateCollection.IsRegistered(transformConfig);
        }
